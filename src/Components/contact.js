        ...
        return (
            <div className="antialiased relative flex flex-col">
                <div className="bg-main p-16 md:p-24 lg:p-32 flex items-center content-center justify-center"
                     id="splash-cont">
                    <h1 className="font-bold text-5xl text-white">Contacto</h1>
                </div>
                <div className="w-full flex flex-col lg:flex-row">
                    ...
                    <div className="w-full lg:w-1/2">
                        <form action="" className="form p-6 my-10 relative w-4/5 mx-auto">
                            <h3 className="text-2xl mb-8 text-gray-900 font-semibold">Platiquemos un rato</h3>
                            <div className="flex space-x-5 mt-3 mb-8">
                                <input type="text" name="" id="" placeholder="Nombre" className="border px-2 py-4 rounded w-1/2"/>
                                <input type="tel" name="" id="" placeholder="Celular"
                                       className="border rounded px-2 py-4 w-1/2"/>
                            </div>
                            <input type="email" name="" id="" placeholder="Email"
                                   className="border rounded px-2 py-4 mb-8 w-full mt-3"/>
                            <textarea name="" id="" cols="10" rows="3" placeholder="Mensaje"
                                      className="border rounded p-2 mb-8 mt-3 w-full"/>
                            <p className="font-bold text-sm mt-3">Aviso de privacidad *</p>
                            <div className="flex items-baseline space-x-2 mt-2 mb-8">
                                <input type="checkbox" name="" id="" className="inline-block rounded"/>
                                <p className="text-gray-600 text-sm">Soy consciente de que esta página web almacene mis datos ingresados para contestar a mi mensaje.</p>
                            </div>
