...
class Abilities extends Component {
    ...
    render() {
        return (
            <div className="flex flex-col my-20 py-10 relative" id="abilities">
                ...
                <div className="flex flex-row mt-10 z-20">
                    <div className="w-1/2">
                        <div className="w-4/5 mx-auto shadow-xl rounded-md p-10 bg-white">
                            <h2 className="font-bold text-xl">Lenguajes</h2>
                            <hr className="my-5"/>
                            <h3 className="my-4 font-semibold">HTML & CSS</h3>
                            <Progressbar barlength="80%" />
                            <h3 className="my-4 font-semibold">Javascript</h3>
                            <Progressbar barlength="60%" />
                            <h3 className="my-4 font-semibold">Python</h3>
                            <Progressbar barlength="85%" />
                            <h3 className="my-4 font-semibold">PHP</h3>
                            <Progressbar barlength="45%" />
                            <h3 className="my-4 font-semibold">Go</h3>
                            <Progressbar barlength="30%" />
                        </div>
                    </div>
